...
spades.py -1 ./${AF}R1_001.trimmed.fastq.gz -2 ./${AF}R2_001.trimmed.fastq.gz -o . --threads 16 --isolate --only-assembler  -m 400000
...
# log file
rsync -av $SPADES/scripts/spades_AF.$JOB_ID.log $SPADES/logs
